...
//       std::vector<std::vector<TH1*>> hA_FRS_ZAoQ_implants_e_gate;
     ...
     // std::vector<TH2*> hA_FRS_Z1Z2_x2AoQ_implants_e_xy;
      ...
      TH1 *hA_FRSWR_GeWR;
      TH1 *hA_FRS_GeE;
      TH2 *hA_FRS_ZAoQ_GeEvsT_all; // done
      TH1 *hA_FRS_ZAoQ_GeE[MAX_FRS_GATE]; // done
      TH1 *hA_FRS_Z1Z2_X2AoQ_GeE[MAX_FRS_GATE]; // done
      TH2 *hA_FRS_Z1Z2_X2AoQ_GeEvsT[MAX_FRS_GATE]; // done
      TH1 *hA_FRS_Z1Z2_X4AoQ_GeE[MAX_FRS_GATE]; // done
      TH2 *hA_FRS_Z1Z2_X4AoQ_GeEvsT[MAX_FRS_GATE]; // done
     // TH2 *hA_FRS_GeEvsT;
      TH2 *hA_FRS_ZAoQ_GeEvsT[MAX_FRS_GATE]; // done
      TH2 *hA_FRS_ZAoQ_GeE1_GeE2[MAX_FRS_GATE]; // done
      TH2 *hA_FRS_Z1Z2_X2AoQ_GeE1_GeE2[MAX_FRS_GATE]; // done
      TH2 *hA_FRS_Z1Z2_X4AoQ_GeE1_GeE2[MAX_FRS_GATE]; // done
      ...
      TH1 *hA_FRS_Z1Z2_X2AoQ_GeE_mhtdc[10][MAX_FRS_GATE]; // done
      TH2 *hA_FRS_Z1Z2_X2AoQ_GeEvsT_mhtdc[10][MAX_FRS_GATE]; // done
      TH1 *hA_FRS_Z1Z2_X4AoQ_GeE_mhtdc[10][MAX_FRS_GATE]; // done
      TH2 *hA_FRS_Z1Z2_X4AoQ_GeEvsT_mhtdc[10][MAX_FRS_GATE]; // done
     // TH2 *hA_FRS_GeEvsT;
      TH2 *hA_FRS_ZAoQ_GeEvsT_mhtdc[10][MAX_FRS_GATE]; // done
      TH2 *hA_FRS_ZAoQ_GeE1_GeE2_mhtdc[10][MAX_FRS_GATE]; // done
      TH2 *hA_FRS_Z1Z2_X2AoQ_GeE1_GeE2_mhtdc[10][MAX_FRS_GATE]; // done
      TH2 *hA_FRS_Z1Z2_X4AoQ_GeE1_GeE2_mhtdc[10][MAX_FRS_GATE]; // done
